...
all_coords_ok <- all(
  c(min(nyc_squirrels[["lat"]]) > 40.76400,
    max(nyc_squirrels[["lat"]]) < 40.80100,
    min(nyc_squirrels[["long"]]) > -73.98300,
    max(nyc_squirrels[["long"]]) < -73.94735)
)
...
if (any(grepl("+", nyc_squirrels[["primary_fur_color"]], fixed = TRUE))) {
